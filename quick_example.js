...
var PThread = {
 ...
 allocateUnusedWorker: function() {
  if (!Module["locateFile"]) {
   PThread.unusedWorkers.push(new Worker(new URL("quick_example.worker.js", import.meta.url)));
   return;
  }
  var pthreadMainJs = locateFile("quick_example.worker.js");
...
var proxiedFunctionTable = [ null, exitOnMainThread, ___syscall_open, _emscripten_set_canvas_element_size_main_thread, _environ_get, _environ_sizes_get, _fd_close, _fd_read, _fd_seek, _fd_write ];
...
var __emscripten_main_thread_futex = Module["__emscripten_main_thread_futex"] = 29268;

var __emscripten_allow_main_runtime_queued_calls = Module["__emscripten_allow_main_runtime_queued_calls"] = 28868;
